...
public class ProfilePagePostsAdapter extends RecyclerView.Adapter<ProfilePagePostsAdapter.ViewHolder> {

    private final Activity activity;
    private List<Post> mPosts;

    // pass in the Tweets array into the constructor
    public ProfilePagePostsAdapter(Activity activity, List<Post> posts) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ViewHolder viewHolder = new ViewHolder(activity, postView);
        return viewHolder;
...
//            ivProfileImage = (ImageView) itemView.findViewById(R.id.ivProfileImage);
            ivPostImage = (ImageView) itemView.findViewById(R.id.iv_profile_post);
